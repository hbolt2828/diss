...
smoothing_centre <- as.Date("2020-03-16", format = "%Y-%m-%d")
...
cases_15th_mar <- cases_by_onset[cases_by_onset$Date == "2020-03-15", 2:4]
cases_16th_mar <- cases_by_onset[cases_by_onset$Date == "2020-03-16", 2:4]
cases_17th_mar <- cases_by_onset[cases_by_onset$Date == "2020-03-17", 2:4]

# adjusted the number of cases using the linear interpolation
adj_cases_16th_mar <- (cases_15th_mar + cases_17th_mar)/2 
...
cases_by_onset[cases_by_onset$Date == "2020-03-16", 2:4] <- adj_cases_16th_mar
cases_to_distribute <- (cases_16th_mar - adj_cases_16th_mar)/total_days_smoothing
...
NorthWest_case_age<- c(0.530649588, 1.341872522, 10.79597438, 11.8389753, 13.42482464, 17.17596828, 10.50930162, 11.3937176, 22.98871607) 
...
UK_case_age <- c(0.742898984, 1.50512046, 10.21193723, 12.40758255, 13.95744984, 16.54412139, 10.68228738, 11.11094162, 22.83766055)  
