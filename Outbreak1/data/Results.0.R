...
# Load functions
source("~/desktop/mcmc_summary.0.R")
source("~/desktop/mcmc_with_my_prior.R")

# Read input raw data
data <- readRDS("~/desktop/age_disaggregated_onset_incidence_data.rds")
observed_deaths <- c(5, 15, 57, 142, 457, 1627, 3589, 7362, 17670)
observed_cases <- c(1461, 2960, 20083, 24401, 27449, 31257,  21008, 21950, 44796) 
prop_NorthWest <- 5047 / 30924
crude_cfr <- 35493 / 246208
