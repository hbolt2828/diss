...
observed_deaths <- c(5, 15, 57, 142, 457, 1627, 3589, 7362, 17670) # (by age of UK, summing up England, Welsh, NI, Scotland data from Gov. UK
prop_deaths_NorthWest <- 5047 / 30924  # Using sum of values above and North West dates over this period from Gov.UK. #15492
...
Gov_observed_deaths <- 35493
Gov_observed_cases <- 246208
