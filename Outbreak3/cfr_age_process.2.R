...
##   UK from information from the Italian Health Deparment. This is integrated    ##
##   with information on the Age distribution of cases from reports from the      ##
##   Italian Govt to calculate the age distribution of cases for NorthWest 	      ##
##   and the rest of UK.                                                          ##
##                                                                                ##
...
Gov_UK_report_onset <- read.csv("~/desktop/Gov_UK_onset_data.2.csv")
...
cases_by_onset <- Gov_UK_report_onset %>%
...
cases_by_onset[cases_by_onset$Date == "2020-10-28", 2:4] <- adj_cases_28th_jun
